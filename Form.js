class Form{
    constructor(){
        ...
        //question 1
        this.question1 = createElement('h4', "Q1. Do you think that extra-curricular activities are benefical for a child?");
        ...
        //question 2
        this.question2 = createElement('h4', "Q2. Should we start clubs based on the strengths of a child?");
        ...
        //question 3
        this.question3 = createElement('h4', "Q3. How much would you like to contribute for this purpose");
        ...
        //question 4
        this.question4 = createElement('h4', "Q4. How often should these clubs take place?");
        this.radio3 = createRadio('h5');
        this.radio3.option('Once a week');
        this.radio3.option('Twice a week');
        this.radio3.option('Thrice a week');
